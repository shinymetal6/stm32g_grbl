...
uint8_t system_control_get_state()
{
  ...
  if ( HAL_GPIO_ReadPin(CONTROL_SAFETY_DOOR_PORT,CONTROL_SAFETY_DOOR_BIT) )
	  control_state |= CONTROL_PIN_INDEX_SAFETY_DOOR;
#endif
  if ( HAL_GPIO_ReadPin(CONTROL_PIN_PORT,CONTROL_RESET_BIT) )
	  control_state |= CONTROL_PIN_INDEX_RESET;
  if ( HAL_GPIO_ReadPin(CONTROL_PIN_PORT,CONTROL_FEED_HOLD_BIT) )
	  control_state |= CONTROL_PIN_INDEX_FEED_HOLD;
  if ( HAL_GPIO_ReadPin(CONTROL_PIN_PORT,CONTROL_CYCLE_START_BIT) )
